...
//Global State
var toothTimers = [],
  toothStartTimers = []; //Timers to keep the teeth decaying
...
function showSplashScreen() {
  ...
  splashText = game.add.text(0, 0, 'Click To Start...', {
    fontSize: '30px',
    fill: '#FFF',
    stroke: '#000',
    strokeThickness: 6,
  ...
  muteText = game.add.text(0, 0, 'press \'M\' at any time to mute', {
    fontSize: '15px',
    fill: '#888',
    boundsAlignV: 'middle',
    boundsAlignH: 'right'
...
function startLevel() {
  ...
  showToothBrush();
  var levelText = game.add.text(0, 0, level.name, {
    fontSize: '30px',
    fill: '#FFF',
    stroke: '#000',
    strokeThickness: 6,
